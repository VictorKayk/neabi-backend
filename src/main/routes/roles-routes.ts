...
import { makeCreateRoleController, makeReadRoleByIdController } from '@/main/factories/roles';
...
export function roles(router: Router) {
  ...
  router.get('/roles/:id', authentication, routerAdapter(makeReadRoleByIdController()));
}
