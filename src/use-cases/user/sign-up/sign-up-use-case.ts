...
import { IUserRepositoryReturnData, IUserRepository, IEncrypter } from '@/use-cases/user/interfaces';
import { IUniversallyUniqueIdentifierGenerator, IUseCase, IHasher } from '@/use-cases/interfaces';
