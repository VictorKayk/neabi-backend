...
describe('DeleteUserById Route', () => {
  it('Should return 200 on delete user by id route success', async () => {
    const { user } = makeSut();
  ...
  it('Should return 401 if user do not exist in delete user by id route', async () => {
    const { user } = makeSut();
  ...
  it('Should return 500 if delete user by id route throws', async () => {
    const { user } = makeSut();
